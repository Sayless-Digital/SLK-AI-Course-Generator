      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <p className="mt-4 text-lg text-muted-foreground">
              At {companyName}, we believe in the transformative power of education and the endless possibilities that Artificial Intelligence unlocks. That's why we've developed {appName}, a revolutionary SaaS product designed to make course creation seamless, efficient, and intelligent.
            </p>
            <p className="mt-4 text-lg text-muted-foreground">
              Empowering educators, professionals, and organizations to create exceptional learning experiences effortlessly is at the heart of what we do. {appName} embodies our commitment to leveraging AI technology to simplify the course development process and unlock new realms of educational excellence. Founded with a passion for innovation, Spacester has been on a journey to redefine the intersection of education and technology. Our team of experts, driven by a shared vision, has dedicated years to create {appName} as a testament to our commitment to advancing the field of online learning. At Spacester, quality is non-negotiable. {appName} is the result of meticulous development, incorporating the latest advancements in AI technology to provide you with a tool that exceeds expectations.
            </p>
          </div>
        </div>
      </section>
